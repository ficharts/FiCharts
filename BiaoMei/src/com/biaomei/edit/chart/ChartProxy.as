package com.biaomei.edit.chart
{
	...
	public class ChartProxy extends Sprite
	{
		...
		public function ChartProxy()
		{
			...
			seriesClassMap.put(ChartTypePanel.LINE, "com.biaomei.edit.chart.LineProxy");
			seriesClassMap.put(ChartTypePanel.COLUMN, "com.biaomei.edit.chart.ColumnProxy");
			seriesClassMap.put(ChartTypePanel.PIE, "com.biaomei.edit.chart.PieProxy");
			seriesClassMap.put(ChartTypePanel.AREA, "com.biaomei.edit.chart.AreaProxy");
			seriesClassMap.put(ChartTypePanel.BAR, "com.biaomei.edit.chart.BarProxy");
			seriesClassMap.put(ChartTypePanel.MARKER, "com.biaomei.edit.chart.MarkerProxy");
			seriesClassMap.put(ChartTypePanel.BUBBLE, "com.biaomei.edit.chart.BubbleProxy");
			seriesClassMap.put(ChartTypePanel.STACKED_COLUMN, "com.biaomei.edit.chart.StackedColumnProxy");
			seriesClassMap.put(ChartTypePanel.STACKED_BAR, "com.biaomei.edit.chart.StackedBarProxy");
			seriesClassMap.put(ChartTypePanel.STACKED_PERCENT_COLUMN, "com.biaomei.edit.chart.StackedPercentColumnProxy");
		 ...
		 * 获取基于模板的配置文件
		 */		
		public function getConfigXMLForRender():XML
		{
			var result:XML = <config title={this.title}>
							 </config>;
		...
		/**
		 */		
		public function getDataForRender():Array
		{
			var result:Array = [];
			
			if (ifHasSeries())
			{
				var len:uint = dataLen;
				var dataItem:Object;
		...
		private function checkAxis(config:XML):void
		{
			...
			{
				axis = <axis>
						 <x type={ChartProxy.FIELD} title={this.hTitle} autoLabelLayout={this.labelDisplay} isAutoLabelLayout="true"/>
		...
		/**
		 */		
		private var labelDisplay:String = "rotation";
